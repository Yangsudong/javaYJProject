...
public class HyundaiController implements Initializable {
	...
	Button btnbmw3, btnbmw5, btnbmw7, btnbmwX, btna4, btna6, btna7, btnq7, btnc, btne, btns, btnX, btnavante, btnsonata,
			btngrandure, btnsantafe, btnK5, btnK7, btnK3, btnSorrento, btnHyundai, btnKIA, btnBMW, btnBenz, btnAudi, btnLogout
			,btng;
	...
	public void AvantebuttonAction(ActionEvent av) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Hyundai/Avante.fxml"));
	...
	public void SonatabuttonAction(ActionEvent sn) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Hyundai/Sonata.fxml"));
			Scene scene = new Scene(root);
	...
	public void grandurebuttonAction(ActionEvent gr) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Hyundai/Grandure.fxml"));
			Scene scene = new Scene(root);
			gran.setScene(scene);
			gran.show();
	...
	public void SantafebuttonAction(ActionEvent sf) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Hyundai/Santafe.fxml"));
			Scene scene = new Scene(root);
	...
	public void K5buttonAction(ActionEvent K5) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Kia/K5.fxml"));
			Scene scene = new Scene(root);
			K51.setScene(scene);
			K51.show();
	...
	public void K3buttonAction(ActionEvent K3) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Kia/K3.fxml"));
			Scene scene = new Scene(root);
			K31.setScene(scene);
			K31.show();
	...
	public void K7buttonAction(ActionEvent K7) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Kia/K7.fxml"));
			Scene scene = new Scene(root);
			K71.setScene(scene);
			K71.show();
	...
	public void SorrentobuttonAction(ActionEvent Sorrento) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Kia/Sorrento.fxml"));
			Scene scene = new Scene(root);
	...
	public void bmws3buttonAction(ActionEvent s3) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/BMW/3S.fxml"));
			Scene scene = new Scene(root);
			bmw3.setScene(scene);
			bmw3.show();
	...
	public void bmws5buttonAction(ActionEvent s5) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/BMW/5S.fxml"));
			Scene scene = new Scene(root);
			bmw5.setScene(scene);
			bmw5.show();
	...
	public void bmws7buttonAction(ActionEvent s7) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/BMW/7S.fxml"));
			Scene scene = new Scene(root);
			bmw7.setScene(scene);
			bmw7.show();
	...
	public void bmwsxbuttonAction(ActionEvent sx) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/BMW/XS.fxml"));
			Scene scene = new Scene(root);
			bmwX.setScene(scene);
			bmwX.show();
	...
	public void a4buttonAction(ActionEvent aa4) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Audi/A4.fxml"));
			Scene scene = new Scene(root);
			a4.setScene(scene);
			a4.show();
	...
	public void a6buttonAction(ActionEvent aa6) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Audi/A6.fxml"));
			Scene scene = new Scene(root);
			a6.setScene(scene);
			a6.show();
	...
	public void a7buttonAction(ActionEvent aa7) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Audi/A7.fxml"));
			Scene scene = new Scene(root);
			a7.setScene(scene);
			a7.show();
	...
	public void q7buttonAction(ActionEvent qq7) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Audi/Q7.fxml"));
			Scene scene = new Scene(root);
			q7.setScene(scene);
			q7.show();
	...
	public void btncbuttonAction(ActionEvent bc) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Bentz/C.fxml"));
			Scene scene = new Scene(root);
			cl.setScene(scene);
			cl.show();
	...
	public void btnebuttonAction(ActionEvent be) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Bentz/E.fxml"));
			Scene scene = new Scene(root);
			el.setScene(scene);
			el.show();
	...
	public void btnsbuttonAction(ActionEvent bs) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Bentz/S.fxml"));
			Scene scene = new Scene(root);
			sl.setScene(scene);
			sl.show();
	...
	public void bntgbuttonAction(ActionEvent bg) {
		...
		Parent root;
		try {
			root = FXMLLoader.load(getClass().getResource("/Bentz/G.fxml"));
			Scene scene = new Scene(root);
			gl.setScene(scene);
			gl.show();
